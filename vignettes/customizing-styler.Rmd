...
serialized, so it is not relevant for styling directly.
These columns are to some degree redundant obviously (execpt for the first and the last 
element). 
...
`col2`, `line1`, `line2`, in any of your function since these columns do only
