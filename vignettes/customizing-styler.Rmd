...
of functinos such as `style_text()` and friends. The transformers are a named
...
enriching the parse table (so it is not acually a transformer), the other 
...
how? Its imput is a flat parse table. Since the visitor (functions `pre_visit()`
...
I hope you have aquired a basic understanding of how you can provide your own
tranformer functions. One thing is really important ha not yet been said though,
and it is 
